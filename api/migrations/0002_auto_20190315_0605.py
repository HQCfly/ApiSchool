...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='course',
            options={'verbose_name_plural': '06. 课程表'},
        ),
        migrations.AlterField(
            model_name='coursecategory',
            name='name',
            field=models.CharField(max_length=64, unique=True, verbose_name='课程大类名称'),
        ),
        migrations.AlterField(
            model_name='coursedetail',
            name='course_slogan',
            field=models.CharField(blank=True, max_length=125, null=True, verbose_name='口号'),
        ),
        migrations.AlterField(
            model_name='coursesubcategory',
            name='name',
            field=models.CharField(max_length=64, unique=True, verbose_name='课程子类名称'),
        ),
        migrations.AddField(
