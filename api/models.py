...
class CourseCategory(models.Model):
    """课程大类, e.g 前端  后端..."""
    name = models.CharField(max_length=64, unique=True,verbose_name="课程大类名称")
...
class CourseSubCategory(models.Model):
    ...
    name = models.CharField(max_length=64, unique=True,verbose_name="课程子类名称")
...
class CourseDetail(models.Model):
    ...
    course_slogan = models.CharField(max_length=125, blank=True, null=True,verbose_name='口号')
...
class Account(models.Model):
    ...
    uid = models.CharField(max_length=64, unique=True, help_text='微信用户绑定和CC视频统计',default="")  # 与第3方交互用户信息时，用这个uid,以避免泄露敏感用户信息
...
class TransactionRecord(models.Model):
    ...
    class Meta:
        verbose_name_plural = "40. 账号金额交易记录"
